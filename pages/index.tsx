...
const Home: NextPage = () => {
  const [selectedType, setSelectedType] = useState({ value: 'image/png', label: 'image/png' });
            ...
            <Stack spacing={6}>
                    ...
                    <Stack spacing={3}>
                      ...
                      <Box>
                        <NumberInput
                          ...
                          name='quality'
                          value={quality}
                          onChange={(value) => handleChangeNumberInput({ target: { name: 'quality', value }})}
              ...
              <Stack spacing={3}>
                ...
                <Box>
                  <NumberInput
                    ...
                    value={margin}
                    isDisabled={includeOptions ? false : true}
                    onChange={(value) => handleChangeNumberInput({ target: { name: 'margin', value }})}
                  >
                    <NumberInputField />
                    <NumberInputStepper>
                      <NumberIncrementStepper />
              ...
              <Stack spacing={3}>
                ...
                <Box>
                  <NumberInput
                    ...
                    value={scale}
                    isDisabled={includeOptions ? false : true}
                    onChange={(value) => handleChangeNumberInput({ target: { name: 'scale', value }})}
                  >
                    <NumberInputField />
                    <NumberInputStepper>
                      <NumberIncrementStepper />
              ...
              <Stack spacing={3}>
                ...
                <Box>
                  <NumberInput
                    ...
                    value={width}
                    isDisabled={includeOptions ? false : true}
                    onChange={(value) => handleChangeNumberInput({ target: { name: 'width', value }})}
                  >
                    <NumberInputField />
                    <NumberInputStepper>
                      <NumberIncrementStepper />
              ...
              <Stack spacing={3}>
                ...
                <Box>
                  ...
                  { displayDarkColorPicker ? <div style={{ position: 'absolute', zIndex: '2' }}>
                    <div
                      style={{ 
                        position: 'fixed',
                        top: '0px',
              ...
              <Stack spacing={3}>
                ...
                <Box>
                  ...
                  { displayLightColorPicker ? <div style={{ position: 'absolute', zIndex: '2' }}>
                    <div 
                      style={{
                        position: 'fixed',
                        top: '0px',
